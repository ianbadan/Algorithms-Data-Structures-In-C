...
int inicializaArvoreAVL(ArvoreAVL *a){
...
int ArvoreAVLVazia(ArvoreAVL *a){
    if(a->raiz==NULL){
        return 1;
    }
    return 0;
...
int balanceamento(No *raiz){
    if(raiz->bal>=2){
        ...
        calculaFB(raiz);
        calculaFB(raiz->direita);
        calculaFB(raiz->esquerda);
    }
    if(raiz->bal<=-2){
...
int insereRaiz(ArvoreAVL *a, int valor){
    if(a->naoInicializada){
...
int inserirArvore(ArvoreAVL *a, int valor){
    if(a->naoInicializada){
        printf("Arvore não inicializada\n");
        return -1;
    }
...
int remover(ArvoreAVL *a, int valor){
    if(a->naoInicializada){
        printf("Arvore não inicializada\n");
        return -1;
    }
